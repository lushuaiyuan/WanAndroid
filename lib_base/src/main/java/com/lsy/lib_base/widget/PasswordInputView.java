...
public class PasswordInputView extends InputView {
    ...
    protected ImageView[] getLeftIcons() {
        ...
        mIvPasswordIcon.setImageResource(R.mipmap.ic_password_normal);
    ...
    protected ImageView[] getRightIcons() {
        ...
        mIvDeleteIcon.setImageResource(R.mipmap.ic_delete);
        ...
        mIcEyeIcon.setImageResource(R.mipmap.ic_eye_normal);
